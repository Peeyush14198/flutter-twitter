...
class CustomLoaderWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return CustomLoaderWidgetState();
  }
}

class CustomLoaderWidgetState extends State<CustomLoaderWidget>
  ...
  void initState() {
    ...
    animation1 = Tween<double>(begin: -1.0, end: 1.0).animate(CurvedAnimation(
